...
public class Mobile  implements Exchangable, Repairable, Sellable, Talking {
    ...
    private MobileCart.MobileType mobileType;
    private MobileCart.RingType ringType;
    private MobileCart.DailType dailType;

    public Mobile(String name, double price, String brand, MobileCart.MobileType mobileType, MobileCart.RingType ringType, MobileCart.DailType dailType) {
        this.name = name;
        this.price = price;
        this.brand = brand;
